...
def build_cases() -> List[Dict[str, Any]]:
    return [
        ...
        {"id": "B22_git_checkout_uncommitted", "tool": "bash", "command": "git checkout -- .", "expect": "ask", "why": "descarta cambios sin commit"},
        {"id": "B23_git_restore", "tool": "bash", "command": "git restore .", "expect": "ask", "why": "descarta cambios sin commit"},
        {"id": "B24_git_stash_drop", "tool": "bash", "command": "git stash drop stash@{0}", "expect": "ask", "why": "borra stash"},
