...
// ── Extension entrypoint (required for auto-discovery compatibility) ───────
// This file is imported by other extensions for shared theme logic, but because
// extension discovery auto-loads *.ts files in ~/.pi/agent/extensions, we also
// expose a no-op default export so the loader accepts it.
